class DVAManager {
    ...
    tutorial_cards = [
        ...
        `<p> So please sit comfortably in a position you could maintain for the next 60-90 minutes.</p>`, null],
        ["Roll up a sheet of paper into a tube the long way.", null],
        ["Hold up a standard credit or debit card between you and your monitor, with the card the distance of that tube from your eyes.", null],
